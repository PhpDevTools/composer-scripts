...
/**
 * @covers \Gilbertsoft\Composer\ReleaseScripts
 * @uses \Gilbertsoft\Composer\Release\FileReplaceVersionItem
 * @uses \Gilbertsoft\Composer\Scripts
...
final class ReleaseScriptsTest extends TestCase
{
    ...
    public function testExtractVersionCore(
        ...
        TestReleaseScripts::testExtractVersionCore($semver, $major, $minor, $patch);
    ...
    /**
     * @return Iterator<string, array{rawVersion: string, expectedMajor: int, expectedMinor: int, expectedPatch: int}>
     */
    ...
    public function testExtractVersionCoreThrowsOnMissingVersion(): void
    {
        ...
        TestReleaseScripts::testExtractVersionCore('', $major, $minor, $patch);
    }
    ...
    public function testExtractVersionCoreThrowsOnInvalidVersion(): void
    {
        ...
        TestReleaseScripts::testExtractVersionCore('v20100102', $major, $minor, $patch);
    }
